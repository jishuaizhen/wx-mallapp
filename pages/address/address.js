...
Page({
  ...
  formSubmit: function (e) {
    ...
    console.log(adds)
    wx.request({
      url: app.globalData.baseUrl + 'Address/add_adds',
      data: {
  ...
  onLoad: function (options) {
    ...
    //获取省级城市
    wx.request({
      url: app.globalData.baseUrl + 'Address/get_province',
      data: {},
      method: 'POST',
      success: function (res) {
        var status = res.data.status;
  ...
  bindPickerChangeshengArr: function (e) {
    ...
    var that = this;
    wx.request({
      url: app.globalData.baseUrl + 'Address/get_city',
  ...
  bindPickerChangeshiArr: function (e) {
    ...
    var that = this;
    wx.request({
      url: app.globalData.baseUrl + 'Address/get_area',
      data: {
        city: e.detail.value,
        sheng: this.data.sheng
      },
  ...
  bindPickerChangequArr: function (e) {
    ...
    var that = this;
    wx.request({
      url: app.globalData.baseUrl + 'Address/get_code',
      data: {
        quyu: e.detail.value,
        city: this.data.city
      },
